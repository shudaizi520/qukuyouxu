...
class ReleaseVersionTests(unittest.TestCase):
    def test_application_and_static_pages_use_release_1_4_1(self):
        from helper import __version__

        self.assertEqual("1.4.1", __version__)
    ...
    def test_accepts_exact_v_prefixed_application_version(self):
        ...
        self.assertEqual("1.4.1", check_release_version("v1.4.1", "1.4.1"))
