...
class ReleaseVersionTests(unittest.TestCase):
    def test_application_and_static_pages_use_release_1_1_8(self):
        from helper import __version__

        self.assertEqual("1.1.8", __version__)
